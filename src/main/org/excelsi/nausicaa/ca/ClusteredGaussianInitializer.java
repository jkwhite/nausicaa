            ...
            switch(rule.dimensions()) {
                case 1:
                    ...
                    for(int x=0;x<points1;x++) {
                        ...
                        pen.setCell(pnt[0], 0, colors[computeColor(r, colors.length, i, _params.maxPoints)]);
                    }
                    break;
                case 2:
                    ctr[0] = r.nextInt(plane.getWidth());
                    ...
                    for(int j=0;j<points2;j++) {
                        point(r, ctr, max, rad, pnt);
                        pen.setCell(pnt[0], pnt[1], colors[computeColor(r, colors.length, i, _params.maxPoints)]);
                    }
                    break;
                case 3:
