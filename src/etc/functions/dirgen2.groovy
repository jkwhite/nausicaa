...
meta = { ca ->
    [
      ...
      'desc' : 'Builds a visual index from a directory of CA source files',
      'args' : [
        'dir':'source directory',
        'imagedir':'directory where index will be generated',
        'width':'static image width, or -1 to use width from CA',
        'height':'static image height, or -1 to use height from CA',
        'iter':'rule iterations to run before generating static image'
      ]
    ]
}
