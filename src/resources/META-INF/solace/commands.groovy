...
ca = { dims, rule, pal=null, init=null, prelude=0, weight=1d ->
    ...
    def c = new CA(rule, p, init, __random__, __random__.nextLong(), dims[0], dims[1], dims.size()>2?dims[2]:1, prelude, weight, 0, ComputeMode.channel, MetaMode.none, new UpdateMode.SimpleSynchronous(), EdgeMode.defaultMode(), ExternalForce.nop(), new Varmap(), null, 'Nameless');
